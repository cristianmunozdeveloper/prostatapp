...
import com.cristiansofthouse.prostatest.ProstaTestViewModel.Event.Error
import com.cristiansofthouse.prostatest.ProstaTestViewModel.Event.Success
...
@HiltViewModel
class ProstaTestViewModel @Inject constructor(
    ...
    fun saveTestHistory(score: String) {
        disposable.add(
            testHistoryController.insertTestHistory(
                TestHistory(0, "Prostatest", score, Date().time)
            )
